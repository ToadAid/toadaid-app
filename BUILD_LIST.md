...
- **C-P5 — CURRENT:** derive deterministic fresh, stale, and unknown observation-age classifications from exact Bridge metadata, an explicit evaluation time, and a fixture maximum-age policy while continuing to withhold current truth until target comparison and trusted-channel proof exist;
