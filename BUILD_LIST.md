...
- **P4B-P8 — CURRENT:** bound the existing procedural Pond renderer to a deterministic responsive pixel-ratio/frame budget, actual-stage resize observation, hidden/offscreen pause-resume lifecycle, reduced-motion updates, and neutral pointer reset without changing authority or asset admission;
