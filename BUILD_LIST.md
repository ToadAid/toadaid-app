...
- **C-P4 — CURRENT:** rebind Pond to the exact merged Bridge Stage 1I-R1 source contract and admit only its source-owned observation-time metadata, while currentness remains blocked pending a separate Pond freshness policy, target comparison, and trusted-channel proof;
